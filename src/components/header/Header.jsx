                                ...
                                {openOptions && <div className="options">
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <span className="optionCounterNumbe">{options.adult}</span>
                                    ...
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <span className="optionCounterNumbe">{options.children}</span>
                                    ...
                                    <div className="optionItem">
                                        ...
                                        <div className="optionCounter">
                                            ...
                                            <span className="optionCounterNumbe">{options.room}</span>
